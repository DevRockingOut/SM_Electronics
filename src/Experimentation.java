...
public class Experimentation {
	...
	final static int [] BatchSize = {2, 3, 4, 5, 6, 7, 8, 9, 10};
	...
	public static void main(String[] args) {
	    ...
	    RandomSeedGenerator rsg = new RandomSeedGenerator();
	     ...
	     for(int i = 0; i < 1; i++) sds[i] = new Seeds(rsg);
	     	...
	     	{
	     		ElectronicsProject model = new ElectronicsProject(endTime, addPallet, 0, sds[0], false, 0);
	            ...
	            {
	        	 ElectronicsProject model1 = new ElectronicsProject(endTime,addPallet,BatchSize[batch],sds[0], false,0);
